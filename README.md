...
| Feature                                                                                                                                                                                                         | Proof                                                                                                                                                                                                                                                |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloudflare-native background removal via `cf.image segment: "foreground"` (BiRefNet), no external API key                                                                                                       | [`apps/workers/src/adapters/cloudflare/cf-image-segment-provider.ts`](./apps/workers/src/adapters/cloudflare/cf-image-segment-provider.ts), [test](./apps/workers/test/cf-image-segment-provider.test.ts)                                            |
| Pure hexagonal pipeline: validate → upload → bg-removal → flip → store → respond, DI adapters                                                                                                                   | [`apps/workers/src/core/process-image-job.ts`](./apps/workers/src/core/process-image-job.ts), [test](./apps/workers/test/process-image-job.test.ts)                                                                                                  |
| Edge horizontal flip via the Workers Images binding (native, no library/upload)                                                                                                                                 | [`apps/workers/src/adapters/cloudflare/images-transformer.ts`](./apps/workers/src/adapters/cloudflare/images-transformer.ts)                                                                                                                         |
| Capability-token delete: response returns a SHA-256-verified `deleteToken`; only the hash persists                                                                                                              | [`apps/workers/src/core/image-job.ts`](./apps/workers/src/core/image-job.ts)                                                                                                                                                                         |
| Result/share URL contract with shared error envelopes (`POST /api/jobs`, `GET /api/jobs/:id`, `GET /r/:id`, `GET /i/:id`, `GET /i/:id/original`, `DELETE /api/jobs/:id`, `GET /health`)                         | [`apps/workers/src/adapters/hono/app.ts`](./apps/workers/src/adapters/hono/app.ts), [routes test](./apps/workers/test/routes.test.ts)                                                                                                                |
| R2-backed storage for both image bytes and job metadata                                                                                                                                                         | [`r2-image-object-store.ts`](./apps/workers/src/adapters/cloudflare/r2-image-object-store.ts), [`r2-job-repository.ts`](./apps/workers/src/adapters/cloudflare/r2-job-repository.ts)                                                                 |
| PNG matte edge-cleanup post-processing                                                                                                                                                                          | [`apps/workers/src/adapters/cloudflare/png-matte-edge-cleaner.ts`](./apps/workers/src/adapters/cloudflare/png-matte-edge-cleaner.ts), [test](./apps/workers/test/png-matte-edge-cleaner.test.ts)                                                     |
...
| Abuse / security guarding on the worker                                                                                                                                                                         | [abuse-guard test](./apps/workers/test/abuse-guard.test.ts), [security test](./apps/workers/test/security-and-assets.test.ts)                                                                                                                        |
...
| Pulumi-managed Cloudflare infrastructure with a Wrangler deploy split                                                                                                                                           | [`infra/src/deploy/deploy-production.ts`](./infra/src/deploy/deploy-production.ts), [`infra/src/deploy/verify-deploy-contract.ts`](./infra/src/deploy/verify-deploy-contract.ts), [`docs/release.md`](./docs/release.md)                             |
...
PRs are gated by the canonical checks:
